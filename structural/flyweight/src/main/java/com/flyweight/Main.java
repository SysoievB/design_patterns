 ...
 * optimizing memory usage by sharing a common state among multiple objects.
 * It aims to reduce the number of objects created and to decrease memory
 * footprint, particularly useful when dealing with a large number of similar
 * objects.
 * */
public class Main {
...
// Flyweight interface
interface Icon {
    // Method to draw the icon at given coordinates
